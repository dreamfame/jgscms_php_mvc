...
CREATE TABLE `activity`  (
  ...
  `prize_way` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `admin`  (
  ...
  `head_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `area`  (
  ...
  `brief` longblob NULL,
  `intro` longblob NULL,
  `area_map` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `recommend` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `isshow` int(2) NULL DEFAULT NULL,
  `top` int(2) NULL DEFAULT NULL,
  `see` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `images`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `picStr` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `menu`  (
  ...
  `spread` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `news`  (
  ...
  `abstract` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
INSERT INTO `news` VALUES (15, '/images/default.png', '1', '程序员', '', 1, 1, '2018-12-25', '2018-12-25', 0, '艾弗森', '', '');
...
CREATE TABLE `photo`  (
  ...
  `verify` int(4) NULL DEFAULT NULL,
...
-- Records of photo
-- ----------------------------
INSERT INTO `photo` VALUES (1, 'dreamfame', '分享测试', '2018-12-21', 0, 0, '/images/default.png', '/images/default.png', '/images/default.png', '/images/default.png', '/images/default.png', '/images/default.png', '/images/default.png', '/images/default.png', '/images/default.png', 1, 'liuliu', 0);
...
CREATE TABLE `postcard`  (
  ...
  `wishes` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `scenic`  (
  ...
  `brief` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- Records of scenic
-- ----------------------------
INSERT INTO `scenic` VALUES (1, 1, '井冈山', '井冈山：地处湘东-赣西边界，万洋山（为罗霄山脉中段）的北支，据传在东汉年间就已经有人在井冈山居住了。秦朝设郡县制时，井冈山为九江郡庐陵县属地。', '', 4, 0, 1, 0, '2018-12-18', '2018-12-18');
INSERT INTO `scenic` VALUES (3, 1, '发送', '被第三方', 0xE58886E6898BE5A4A7E5B888, 3, 1, 1, 0, '2018-12-19', '2018-12-19');
INSERT INTO `scenic` VALUES (4, 1, '井冈山景点', '工时费', 0xE585ACE58FB8, 4, 1, 1, 0, '2018-12-20', '2018-12-20');
INSERT INTO `scenic` VALUES (5, 2, '大井', '', '', 4, 1, 0, 0, '2018-12-18', '2018-12-18');
